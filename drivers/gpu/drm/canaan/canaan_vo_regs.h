...
#define VO_DISP_DRAW_CTL 0x780

/* VO_DISP_MIX_LAYER_GLB_ALPHA for OSD layer 8 (0x940) */
#define VO_DISP_MIX_OSD8_GLB_ALPHA 0x940
/* OSD mixer select for layers 4-11 (0x950) */
#define VO_DISP_MIX_SEL1 0x950
